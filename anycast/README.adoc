...
Waarvoor zou je Anycast gebruiken? Om op verschillende plaatsen binnen je netwerk toegang te krijgen tot eenzelfde (eigenlijk meerdere, maar bereikbaar op verschillende plaatsen van dezelfde service) *STATELESS* service! Waarom statless?
...
=== Referentie
* https://wiki.mikrotik.com/wiki/Manual:OSPF-examples => router-id aanpassen alleen voor OSPF.