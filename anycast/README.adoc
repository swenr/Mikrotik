...
== Client config
De clients draaien FreeBSD met frr. FreeBSD heeft standaard geen lo1. Deze creëer je met volgend commando `ifconfig lo1 create`.
...
== Problemen
Let er wel zeer goed op dat de router-id's verschillend zijn op alle routers!